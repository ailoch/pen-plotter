...
class PathObject:
    ...
    # per-object overrides replacing a Settings default for just this object. Motion
    # keys apply to this object's own draw moves, in the same units Settings uses
    # (mm, mm/min, mm/s^2). An empty dict (the usual case) changes nothing
